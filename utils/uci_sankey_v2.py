...
##################################################################################
# The function generate_uci_sankey accept pandas dataframe df that is the table 
# production.data_engineering.UCI_ANALYSIS_PIPELINE, and return plotly sankey diagram
##################################################################################
def generate_uci_sankey(df):
    """
    ...
    fig.update_layout(
        ...
        font=dict(
            ...
            color="black", 
            size=20  # Even larger for Sankey nodes
        ),
        width=1300,
        height=800,
